...
// Custom Feature: Computer vision screening automation
// Computer vision screening automation: Patient uploads eye selfie; AI pre-screens for obvious concerns (cataracts, pupil asymmetry); triage to doctor
import React, { useState } from 'react';

export default function CFComputerVisionScreeningAutomationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-computer-vision-screening-automation/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Computer vision screening automation</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Computer vision screening automation: Patient uploads eye selfie; AI pre-screens for obvious concerns (cataracts, pupil asymmetry); triage to doctor</p>
