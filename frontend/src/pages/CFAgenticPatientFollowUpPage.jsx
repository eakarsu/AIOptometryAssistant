...
// Custom Feature: Agentic patient follow-up
// Agentic patient follow-up: Background process monitors patients due for exams; auto-sends SMS/email reminders; predicts best contact method and optimal timing
import React, { useState } from 'react';

export default function CFAgenticPatientFollowUpPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-agentic-patient-follow-up/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Agentic patient follow-up</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Agentic patient follow-up: Background process monitors patients due for exams; auto-sends SMS/email reminders; predicts best contact method and optimal timing</p>
