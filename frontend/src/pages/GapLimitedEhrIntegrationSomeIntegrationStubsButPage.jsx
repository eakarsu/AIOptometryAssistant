...
// Gap (Non-AI): Limited EHR integration (some integration stubs but no Epic/Allscripts adapter)
// Limited EHR integration (some integration stubs but no Epic/Allscripts adapter)
import React, { useState } from 'react';

export default function GapLimitedEhrIntegrationSomeIntegrationStubsButPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-ehr-integration-some-integration-stubs-but/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Limited EHR integration (some integration stubs but no Epic/Allscripts adapter)</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Limited EHR integration (some integration stubs but no Epic/Allscripts adapter)</p>
