...
// Gap (Non-AI): No telemedicine/remote consultation
// No telemedicine/remote consultation
import React, { useState } from 'react';

export default function GapNoTelemedicineRemoteConsultationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-telemedicine-remote-consultation/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No telemedicine/remote consultation</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No telemedicine/remote consultation</p>
