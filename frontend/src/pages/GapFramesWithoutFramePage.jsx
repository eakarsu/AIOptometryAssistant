...
export default function GapFramesWithoutFramePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-frames-without-frame/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Frames without '/frame</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Frames without /frame-style-suggest (personalized recommendations based on demographics)</p>
