...
// Gap (Non-AI): No patient portal for self
// No patient portal for self-service booking and Rx refills
import React, { useState } from 'react';

export default function GapNoPatientPortalForSelfPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-patient-portal-for-self/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No patient portal for self</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No patient portal for self-service booking and Rx refills</p>
