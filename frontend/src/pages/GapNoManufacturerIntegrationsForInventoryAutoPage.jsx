...
// Gap (Non-AI): No manufacturer integrations for inventory auto
// No manufacturer integrations for inventory auto-replenishment
import React, { useState } from 'react';

export default function GapNoManufacturerIntegrationsForInventoryAutoPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-manufacturer-integrations-for-inventory-auto/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>No manufacturer integrations for inventory auto</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>No manufacturer integrations for inventory auto-replenishment</p>
