...
// Custom Feature: Style + fit prediction
// Style + fit prediction: Multi-modal AI takes face photo + lifestyle survey; recommends frames with fit confidence score
import React, { useState } from 'react';

export default function CFStyleFitPredictionPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-style-fit-prediction/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Style + fit prediction</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Style + fit prediction: Multi-modal AI takes face photo + lifestyle survey; recommends frames with fit confidence score</p>
